...
func (zc *ZeroCopyBuffer) BlitFrom(srcImage C.VkImage, layout C.VkImageLayout) error {
	return zc.BlitFromWait(srcImage, layout, nil)
}
...
func (zc *ZeroCopyBuffer) BlitFromWait(srcImage C.VkImage, layout C.VkImageLayout, waitSems []C.VkSemaphore) error {
...
func (zc *ZeroCopyBuffer) BlitFromAsync(srcImage C.VkImage, layout C.VkImageLayout) error {
